...
class MainActivity : ComponentActivity() {
    private var isWelcomed: Boolean? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.isWelcomed.observe(this) { welcome -> isWelcomed = welcome }
        ...
        setContent {
            MovieVerseTheme {
                Surface(
                    ...
                    MovieVerseApp(
                        startedDestination = if (isWelcomed != null && isWelcomed as Boolean)
